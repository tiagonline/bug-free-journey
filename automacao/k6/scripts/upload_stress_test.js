...
// Criação do arquivo de teste (MOCKADO)
// Como não temos um arquivo real, criei um binário fictício
// para simular o payload de um arquivo de 5MB.
// O arquivo é criado uma única vez e compartilhado entre os VUs.
// (Em um cenário real, poderíamos carregar um arquivo do disco)
const fileBin = new SharedArray('mockFile', function () {
    return [new Array(5 * 1024 * 1024).join('a')]; // Cria um 5MB cheio de "a's"
});
...
export const options = {
    ...
    // Aqui se define os SLAs, critérios de aceite para o teste
    thresholds: {
